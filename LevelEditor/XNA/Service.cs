...
namespace ORPG.XNA
{
    ...
    /// or disposed.
    /// </summary>
    class Service : IGraphicsDeviceService
    {
        #region Fields


        // Singleton device service instance.
        static Service singletonInstance;
        ...
        /// </summary>
        Service(IntPtr windowHandle, int width, int height)
        {
        ...
        /// </summary>
        public static Service AddRef(IntPtr windowHandle,
                                                   int width, int height)
        {
            ...
            if (Interlocked.Increment(ref referenceCount) == 1)
            {
                ...
                singletonInstance = new Service(windowHandle,
                                                              width, height);
            }
